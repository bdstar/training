    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s" style="margin: 20px 0;">
                <h6 class="section-title bg-white text-center text-primary px-3">Password Reset</h6>
            </div>
                ...
                <div class="col-lg-4 col-md-3 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item bg-light sign-form">
                        ...
                        <div class="input-group flex-nowrap">
                            ...
                            <input type="password" class="form-control" placeholder="Enter New Password" aria-label="Password" aria-describedby="addon-wrapping-password">
                        </div>

                        <div class="position-relative d-flex justify-content-center">
                            <div class="bg-light d-flex justify-content-center pt-2 px-1">
                                <button type="submit" class="btn btn-sm-square btn-primary mx-1" style="width: 220px; background-color: darkcyan;">Reset Password</button>
                            </div>
                        </div>
